...
//    Tle tle = Tle("SUOMI NPP                ",
//        "1 37849U 11061A   22185.10641315  .00000019  00000+0  29606-4 0  9995",
//        "2 37849  98.7330 123.4279 0001081  87.7600 282.8852 14.19531491553555");
//    SGP4 sgp4(tle);
//
...
//    DateTime start_date_local(start_date.AddHours(3.0));
//
//    DateTime end_date(start_date.AddDays(7.0));
//    DateTime end_date_local(start_date_local.AddDays(7.0));
//
//    std::list<struct PassDetails> pass_list;
//
